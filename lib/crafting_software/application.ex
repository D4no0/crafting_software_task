defmodule CraftingSoftware.Application do
  ...
  def start(_type, _args) do
    children = [
      CraftingSoftwareWeb.Telemetry,
      {DNSCluster, query: Application.get_env(:crafting_software, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: CraftingSoftware.PubSub},
      # Start a worker by calling: CraftingSoftware.Worker.start_link(arg)
